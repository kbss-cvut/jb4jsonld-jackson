...
public class JacksonJsonLdDeserializer extends DelegatingDeserializer {
    ...
    public JacksonJsonLdDeserializer(tools.jackson.databind.ValueDeserializer<?> delegatee, Class<?> resultType,
    ...
    @Override
    protected tools.jackson.databind.ValueDeserializer<?> newDelegatingInstance(
            tools.jackson.databind.ValueDeserializer<?> newDelegatee) {
    ...
    private JsonValue parseJsonObject(JsonParser parser) {
        JsonValue value = null;
        final JsonToken initialToken = parser.currentToken();
